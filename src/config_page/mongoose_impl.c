...
struct attribute s_halow_cfg_attributes[] = {
  {"bandwidth", "string", NULL, offsetof(struct halow_api_cfg, bandwidth), 6, false},
  {"central_freq", "double", "%.1f", offsetof(struct halow_api_cfg, central_freq), 0, false},
  {"super_power", "bool", NULL, offsetof(struct halow_api_cfg, super_power), 0, false},
  {"power_dbm", "int", NULL, offsetof(struct halow_api_cfg, power_dbm), 0, false},
  {"mcs_index", "string", NULL, offsetof(struct halow_api_cfg, mcs_index), 6, false},
...
struct apihandler_data s_apihandler_halow_cfg = {{"halow_cfg", "data", false, 0, 0, 0UL}, s_halow_cfg_attributes, sizeof(struct halow_api_cfg), (void (*)(void *)) glue_get_halow_cfg, (void (*)(void *)) glue_set_halow_cfg};
